...
```{r fig-titer_density_ageT1, fig.height = 2 * eps * figh}
#| fig-cap: "Distributions of titers across all sites and time points for the 20 age
#| classes and the 3 time points. Colors show 20 ranges of high density intervals (HDI)
#| from 0 (yellow) to 1 (red) by steps of 0.05."
dataset |> 
  group_by(time_point) |> 
  group_walk(~ plot_titers_age_profile(.x))
```
