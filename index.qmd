...
models_prev |> 
  ...
  first() |>
  predict2() |>
  plot_pred(ylog = FALSE, ylab = "prevalence", ylim = 0:1, yaxs = "i", col = 3)

gam(positive2 ~ s(age, bs = "tp", k = 50), binomial, data2, method = "REML") |> 
  predict2() |> 
  add_ribbon(2)
...
```{r include=FALSE, eval=FALSE}
gam2(positive1 ~ s(age, bs = "tp", k = 50), binomial, data2) |> 
  predict2() |> 
  plot_pred(ylog = FALSE, ylab = "prevalence", ylim = 0:1, yaxs = "i", col = 3)

gam2(positive2 ~ s(age, bs = "tp", k = 50), binomial, data2) |> 
  predict2() |> 
  add_ribbon(2)
...
data2 |> 
  ...
  image(1:70 - .5, seq(min_titer, max_titer, le = 512), z = _, axes = FALSE,
        xlab = "age (years)", ylab = "titer (IU/L)",
