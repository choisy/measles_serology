...
#| fig-cap: "Number of samples collected as a function of age class and site for the
#| three time points (Dec 2019, Dec 2022 and Apr 2024). Age classes are 1-year age
#| classes from 0 to 20 and 5-year age classes from 20 to 70 year-old. The horizontal
#| red lines show the targetted number of samples per age class which are 5 for the
#| 1-year age classes below 20 year-old and 10 for the 5-year age classes above 20
#| year-old."
